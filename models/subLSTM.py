...
class subLSTM_cell(object):
    ...
    """
    subLSTM cell object which takes 3 arguments for initialization.
    ...
    def SubLstm(self, previous_hidden_memory_tuple, x):
        """
        ...
        # Current subLSTM Hidden state
        current_hidden_state = tf.sigmoid(c) - o
    ...
    def get_states(self):
        ...
        all_hidden_states = tf.scan(self.SubLstm,
